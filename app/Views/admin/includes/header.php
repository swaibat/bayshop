        ...
        <div class="main-wrapper">
                    ...
                    <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-list dropdown-menu-right">
                            ...
                            <div class="dropdown-list-content dropdown-list-message">
                                ...
                                <a href="#" class="dropdown-item">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image" src="<?=base_url('assets/shared/images/user.svg')?>"
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <div class="owner-progress mx-3 mb-2 mt-3 x-2 border-bottom ">
                        <p class='mb-1'>Your Site Setup</p>
                        <div class="progress progres-sm">
                            <div class="progress-bar" role="progressbar" style="width: 25%;" aria-valuenow="25"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <p class='text-secondary mb-1'>2/7 complete</p>
                    </div>
                    <!-- Side Navigation -->
                    <?= custom_navigation(
				  ...
				  [
                    ...
                    <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
                        <a href="#" class="btn btn-sm btn-primary btn-block d-flex align-items-center">
                            <i class="fas fa-rocket mr-2"></i> Documentation
                        </a>
                    </div>
                </aside>
            </div>
