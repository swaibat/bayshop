<form id='form' action="<?= base_url('admin/categories/create') ?>" method="post" enctype="multipart/form-data"
    ...
    <div class="form-row modal-body p-4">
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" name="name" id="name" placeholder="eg. new arrival"
                minlength="3">
        </div>
		<div class="form-group col-md-7">
            <label for="sub">Category Name</label>
            <input type="text" class="form-control select-2" name="sub" id="sub" placeholder="eg. new arrival"
                minlength="3">
        </div>
		<div class="form-group col-md-5 d-flex align-items-center">
			...
			<label id="img-label" for="image" class="input-group img-label mb-3 mt-3 py-3 d-flex align-items-center border-dashed d-flex justify-content-center">
