    ...
    <div class="modal-body p-4">
        ...
        <div class="coupon-form form-row mt-3">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="name" id="name" placeholder="enter name" minlength="3"
                    required>
            </div>
            <div class="form-group col-md-6">
                <label for="code">Coupon code *</label>
                <input type="text" class="form-control" name="code" id="code" minlength="3" placeholder="enter code"
                    required>
            </div>
            <div class="form-group col-md-8">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="date" name="valid_to" id="valid_to" class="form-control" disabled>
                </div>
            </div>
