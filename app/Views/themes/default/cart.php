    ...
    <div class="rounded bg-white p-3 shadow-xs w-100">
        ...
        <form name="cart" action='<?=base_url('shopping/login')?>' method='POST'>
            <table name="cart" class="cart-table table border-0  table-borderless rounded">
                ...
                <tr id='<?= $value['id']?>' class='item-row border-bottom py-3' name="line_items">
                    <td>
                        <span class='d-flex'>
                            ...
                            <span class='d-flex flex-column w-100'>
                                ...
                                <div id='specs' class="d-flex">
                                    ...
                                    <button name='remove' id='<?=$key?>' type="button"
                                        class="btn btn-xs btn-outline-danger ml-auto">remove</button>
                                </div>
                            </span>
                    ...
                    <td><input type="text" class='form-control' readonly name="price" value="<?= $value['price']?>">
                    </td>
                    <td><input type="text" class='form-control' name="item_total" value="" jAutoCalc="{qty} * {price}">
                    </td>
                </tr>
                <?php endforeach ?>
                <tr>
                    <td colspan="2">&nbsp;</td>
                    <td>Subtotal</td>
                    <td><input type="text" class='form-control' id='sub_total' name="sub_total" value=""
                ...
                <tr>
                    ...
                    <td><input type="text" class='form-control' name="tax_total" value=""
                            jAutoCalc="{sub_total} * {tax}"></td>
                </tr>
                <tr>
                    <td colspan="2">&nbsp;</td>
                    <td>Total</td>
                    <td><input type="text" class='form-control' id='total' name="grand_total" value=""
                            jAutoCalc="{sub_total} + {tax_total}"></td>
                </tr>
            </table>
            <div class="w-100 d-flex justify-content-end border-top pt-3">
                <div class='btn-group btn-group-sm ml-auto'>
                    <td colspan="99"><button class="btn btn-outline-primary btn-sm">Continue Shopping</button></td>
                    <td colspan="99"><button type='submit' class="btn btn-primary btn-sm">Process Order</a></td>
