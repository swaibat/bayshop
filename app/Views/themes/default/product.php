<main className='row'>
    <div className='col-md-10'>
        ...
        <div className='row bg-white p-3 rounded mt-4'>
            <ul className='nav nav-pills mb-3 bg-white border-bottom w-100' id='pills-tab' role='tablist'>
                <li className='nav-item'>
                    <a className='nav-link cv-prdct-nav active pb-0' id='pills-home-tab' data-toggle='pill'
                ...
                <li className='nav-item'>
                    <a className='nav-link pb-0 cv-prdct-nav' id='pills-profile-tab' data-toggle='pill'
                ...
                <li className='nav-item'>
                    <a className='nav-link pb-0 cv-prdct-nav' id='pills-contact-tab' data-toggle='pill'
