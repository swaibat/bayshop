<main role="main" class="container">
    <div class='row'>
        ...
        <div class='col-md-2 pb-3'>
            <div class="bg-white shadow-xs rounded p-2 slide-container align-items-start">
    ...
    <div class="d-flex flex-wrap w-100 bg-white rounded border mt-2 shadow-xs p-3">
        ...
        <div class="col-md-3 border-right">
            <div class="d-flex">
                ...
                <span class="mt-2 ml-2">
                    <h6>Free Shiping</h6>
                    <p class='text-truncate'>On orders above $100</p>
                </span>
            </div>
        </div>
        <!-- Orders -->
        <div class="col-md-3 border-right">
            <div class="d-flex">
                ...
                <span class="mt-2 ml-2">
                    ...
                    <p class='text-truncate'>our support is online 24/7</p>
                </span>
            </div>
        </div>
        <!-- Orders -->
        <div class="col-md-3 col-sm-6 border-right">
            <div class="d-flex">
                ...
                <span class="mt-2 ml-2">
                    ...
                    <p class='text-truncate'>secure payment options</p>
                </span>
            </div>
        </div>
        <!-- Orders -->
        <div class="col-md-3">
            <div class="d-flex">
                ...
                <span class="mt-2 ml-2">
                    <h6>User Friendly</h6>
                    <p class='text-truncate'>user friendly system</p>
                </span>
            </div>
        </div>
    </div>
