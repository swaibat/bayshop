...
<body class='pt-5 d-flex flex-column'>
    <header class='w-100 fixed-top bg-white shadow-xs'>
        <nav class="navbar navbar-expand-md navbar-light container border-bottom">
            ...
            <div class="navbar-collapse offcanvas-collapse d-none" id="navbarsExampleDefault">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link " href="<?=base_url('shopping/cart')?>">
                            <ion-icon class='header-icon' name="cart-outline"></ion-icon>
                        </a>
                    </li>
                    <li class="nav-item ml-3">
                        <a class="nav-link" href="#">
                            <ion-icon class='header-icon' name="archive-outline"></ion-icon>
                        </a>
                    </li>
        ...
        <nav class='nav container nav-underline text-capitalize justify-content-center cv-category-nav'
            id='navAccordion'>
            <li class='nav-item'>
