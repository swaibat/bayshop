...
class ProductModel extends Model
{
    ...
    protected $allowedFields = ['title', 'slug','price','discount','sku','collection_id','vendor_id', 'description','category_id','status','seo_title','seo_description','social_title','social_description'];
